function plot_resultados(vSetKeyFrames,mapPointSet, pathOutputs, sufix)

%% PLOTS FINAL
steps_points = 10; % porcentaje de puntos a plotear
steps_camera = 10; % porcentaje camera pose a plotear
...
title ('Top view')
legend('3D points', 'Trayectoria', 'Camara')
saveas(h3,[pathOutputs,'/Final_VSLAM_TopView',sufix,'.png']);
saveas(h3,[pathOutputs,'/Final_VSLAM_TopView',sufix,'.fig']);
close(h3);
