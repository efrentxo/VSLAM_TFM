function plotCameraPose(R, t, scale)
    ...
    plot3([p0(1) p2(1)], [p0(2) p2(2)], [p0(3) p2(3)], 'k', 'LineWidth', 2);
    plot3([p0(1) p3(1)], [p0(2) p3(2)], [p0(3) p3(3)], 'k', 'LineWidth', 2);
    ...
    plot3([p3(1) p4(1)], [p3(2) p4(2)], [p3(3) p4(3)], 'b', 'LineWidth', 2);
    plot3([p4(1) p1(1)], [p4(2) p1(2)], [p4(3) p1(3)], 'b', 'LineWidth', 2);
