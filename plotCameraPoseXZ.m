function plotCameraPoseXZ(R, t, scale)
    ...
    plot([p0(1) p1(1)], [p0(3) p1(3)], 'k', 'LineWidth', 2);
    plot([p0(1) p2(1)], [p0(3) p2(3)], 'k', 'LineWidth', 2);
    plot([p0(1) p3(1)], [p0(3) p3(3)], 'k', 'LineWidth', 2);
    plot([p0(1) p4(1)], [p0(3) p4(3)], 'k', 'LineWidth', 2);

    % Connect frustum base
    plot([p1(1) p2(1)], [p1(3) p2(3)], '--k', 'LineWidth', 2);
    plot([p2(1) p3(1)], [p2(3) p3(3)], '--k', 'LineWidth', 2);
    plot([p3(1) p4(1)], [p3(3) p4(3)], '--k', 'LineWidth', 2);
    plot([p4(1) p1(1)], [p4(3) p1(3)], '--k', 'LineWidth', 2);
