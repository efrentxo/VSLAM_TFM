...
function [currPose, mapPointIdx, featureIdx] = TrackLastKeyFrame(...
...
currPose = bundleAdjustmentMotion(matchedWorldPoints(inlier,:), ...
    matchedImagePoints(inlier,:), currPose, intrinsics, ...
    'PointsUndistorted', false, 'AbsoluteTolerance', 1e-7,...
    'RelativeTolerance', 1e-15, 'MaxIteration', 20);
...
% menos de 10 matches, no me vale
...
% Obtain the index of matched map points and featuresestimateWorldCameraPose
